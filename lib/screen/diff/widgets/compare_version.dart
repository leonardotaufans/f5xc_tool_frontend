...
class CompareVersionWidget extends StatefulWidget {
  final String jsonData;

  const CompareVersionWidget({super.key, required this.jsonData});

  @override
  State<CompareVersionWidget> createState() => _CompareVersionWidgetState();
}

class _CompareVersionWidgetState extends State<CompareVersionWidget> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: CodeTheme(
        ...
        child: CodeField(controller: _controller, enabled: false,),
      ),
    );
  }
  ...
  void initState() {
    ...
    _controller = CodeController(
        language: json, text: getPrettyJsonString(widget.jsonData));
  }

  String getPrettyJsonString(jsonObject) {
    var encoder = JsonEncoder.withIndent('  ');
    return encoder.convert(jsonDecode(widget.jsonData));
  }
}
