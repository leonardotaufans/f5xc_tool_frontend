...
class CDNChangesDialog extends StatefulWidget {
  final CDNLBRevisionModel revision;
  final String environment;

  const CDNChangesDialog(
      {super.key, required this.revision, required this.environment});

  @override
  State<CDNChangesDialog> createState() => _CDNChangesDialogState();
}

class _CDNChangesDialogState extends State<CDNChangesDialog> {
  ...
  Future<CompareModel> getCDNComparison(CDNLBRevisionModel revision) async {
